...
const Features = () => {
  ...
  return (
    <div id="features" className="flex flex-col items-center my-10 scroll-mt-12">
        ...
        <div className="flex items-center gap-2 text-sm text-blue-600 bg-blue-400/10 border border-blue-200 rounded-full px-6 py-2">
        <Zap width={16}/>
            <span>Simple Process</span>
        </div>

        <Title title={"Build your resume"} description={"Our streamlined process helps you create a professional resume in minutes with intellegent AI-Powered tools and features."}/>

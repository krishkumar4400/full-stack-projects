      ...
      <div className="min-h-screen pb-20">
        ...
        <nav className="z-50 flex items-center justify-between w-full py-4 px-6 md:px-16 lg:px-24 xl:px-40 text-sm">
          ...
          <div className="hidden md:flex items-center gap-8 transition duration-500 text-slate-800">
            <Link to={'/'} onClick={() => navigate('/')} className="hover:text-blue-600 transition">
              Home
            </Link>
        ...
        >
          ...
          <button
            ...
            className="active:ring-3 active:ring-white aspect-square size-10 p-1 items-center justify-center bg-blue-600 hover:bg-blue-800 transition text-white rounded-md cursor-pointer flex"
          >
            X
          </button>
        </div>
        ...
        <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-black">
          ...
          <h1 className="text-5xl md:text-6xl font-semibold max-w-5xl text-center mt-4 md:leading-[70px]">
            ...
            <span className=" bg-gradient-to-r from-blue-700 to-blue-500 bg-clip-text text-transparent text-nowrap">
              AI-Powered{" "}
            </span>{" "}
            resumes.
          </h1>
